...
public class MessengerHooks extends HookedApp {
    ...
    private static boolean cheatInSoccer;
    private static int soccerScoreToCheat;

    public static final String LOG_TAG = XposedModule.getLogtag(MessengerHooks.class);
    ...
    public static void setHooksEnabled(boolean hooksEnabled) {
        MessengerHooks.hooksEnabled = hooksEnabled;
    }

    public static void setCheatInSoccer(boolean cheatInSoccer) {
        MessengerHooks.cheatInSoccer = cheatInSoccer;
    }

    public static void setSoccerScoreToCheat(int soccerScoreToCheat) {
        MessengerHooks.soccerScoreToCheat = soccerScoreToCheat;
    }
}
